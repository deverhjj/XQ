...
//		postReport(Constant.ERROR_LOG_PATH+fileName);
    ...
    private void postReport(String filePath) {
		...
		Call<String> call =  ServiceUtil.createService(APIService.class).uploadErrorLog2(ServiceUtil.filesToMultipartBody("upFile",paths,MediaType.parse("multipart/form-data")));
	...
	infos.put("=========【奔溃时间】=========", "=");
	infos.put("Date", Utils.getCurrentDate2());
	try {
