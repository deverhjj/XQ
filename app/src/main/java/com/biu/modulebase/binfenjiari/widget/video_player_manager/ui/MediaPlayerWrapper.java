...
//      TODO: if (SHOW_LOGS) Logger.err(TAG, "catch exception, is Network Connected [" + Utils.isNetworkConnected());
    ...
    /**
     * Play or resume video. Av will be played as soon as view is available and media player is
     * prepared.
     * <p/>
    ...
    public void setSurfaceTexture(SurfaceTexture surfaceTexture) {
        ...
        if(surfaceTexture != null){
            ...
            try {
                ...
                if (SHOW_LOGS) {
                    Logger.v(TAG, "error,cant setSurfaceTexture");
                }
            }
...
//            if (SHOW_LOGS) Logger.v(TAG, "notifyPositionUpdated, mVideoStateListener " + mVideoStateListener);
    ...
    public static String state2String(MediaPlayerWrapper.State state){
        String stateStr="";
        switch (state) {
            case IDLE:
                stateStr="IDLE";
