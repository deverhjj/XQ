...
/**
 * TrustManager that accepts all certificates and hosts. Useful when the server
 * has self signed certificates. Use at your own risk.
 *
...
public class AllCertificatesAndHostsTruster implements TrustManager, X509TrustManager {
	...
	public static void apply() {
		...
		try {
			...
			Log.e("CertHostTruster",
					"Unable to initialize the Trust Manager to trust all the " + "SSL certificates and HTTPS hosts.",
					exc);
		}
	}
}
