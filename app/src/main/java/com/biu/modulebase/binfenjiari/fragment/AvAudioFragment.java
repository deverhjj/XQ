 ...
 */
public class AvAudioFragment extends BaseFragment
        implements AvFragment.Callbacks ,MediaController.VideoPlayCallback {
    private static final String TAG = "AvAudioFragment";

    private final static int AV_AUDIO_LIKE_REQUEST =113;
            ...
            public BaseViewHolder getViewHolder(final ViewGroup parent, final int viewType) {
                final BaseViewHolder holder=new BaseViewHolder(LayoutInflater.from(getActivity())
                    ...
                    public void bind(BaseViewHolder holder, Object data) {
                        ...
                        setupVideoItem(true, AvAudioFragment.this, holder, mRecyclerView,
                                videoItem.getUrl(), AvAudioFragment
                                        .this);
                    }
                    ...
                    public void onItemClick(BaseViewHolder holder, View view, int position) {
                        ...
                        startActivityForResult(intent,AV_AUDIO_LIKE_REQUEST);
                    }
                });
...
//                        showTost("加载更多",0);
    ...
    private boolean handleViewClick(View view,int position) {
        ...
        if (id == R.id.share) {
            OtherUtil.showShareFragment(AvAudioFragment.this,item.getId(),item.getName(),item.getName(),Constant.SHARE_AUDIO);
            return true;
            ...
            if (item != null) {
                ...
                OtherUtil.like(AvAudioFragment.this, (CheckBox) view, params,
...
//        if (requestCode != REQUEST_VIDEO_STATUS) return;
    ...
    public void onChannelChanged(boolean inVideoChannel,AvFragment.Callbacks selectedChannel) {
        if (!inVideoChannel || !(selectedChannel instanceof AvAudioFragment)) {
