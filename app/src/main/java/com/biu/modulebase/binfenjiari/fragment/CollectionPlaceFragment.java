 ...
 * @date 2016/4/15
 */
public class CollectionPlaceFragment extends BaseFragment {
    ...
    protected void initView(View rootView) {
        ...
        mRefreshLayout.setSwipeRefreshListener(new LSwipeRefreshLayout.SwipeRefreshListener() {
            ...
            public void onLoadMore() {
                pageNum++;
                getJidiLst(Constant.LIST_LOAD_MORE);
            }
        });
        ...
        BaseAdapter adapter = new BaseAdapter(getActivity()) {
            ...
            public BaseViewHolder getViewHolder(ViewGroup parent, int viewType) {
                return new BaseViewHolder(LayoutInflater.from(getActivity()).inflate(R.layout.item_collection_place, parent, false), new BaseViewHolder.Callbacks() {
                    @Override
                    public void bind(BaseViewHolder holder, Object data) {
                        ...
                        holder.setText(R.id.a_num, bean.getActivity_number());
...
//                                });
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(getActivity(), JidiDetailActivity.class);
    ...
    public void loadData() {
        ...
        pageNum = 1;
        getJidiLst(Constant.LIST_REFRESH);
    }

    private void getJidiLst(final int tag) {
