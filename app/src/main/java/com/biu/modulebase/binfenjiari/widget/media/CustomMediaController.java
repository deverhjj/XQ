...
public class CustomMediaController extends MediaController {
    ...
    public void setAnchorView(View view) {
        ...
        addView(controllerView, new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    private void setProgress() {
        ...
        LogUtil.LogE(TAG, "setProgress_curPos="+curPos+",duration="+duration);
    ...
    private void togglePauseStartView(int visibility,boolean forcePlay) {
        ...
        if (mPauseView.isShown()) {
            mPauseView.setImageResource(mPlayer.isPlaying()||forcePlay ? R.mipmap.audio_pause
                    : R.mipmap.audio_start);
        }
    }
