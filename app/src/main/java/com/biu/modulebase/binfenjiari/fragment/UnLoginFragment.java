...
public class UnLoginFragment extends BaseFragment {
    ...
    private void retrofitLogin(String account,String pwd){
        Gson gson=new Gson();
...
//        Call<String> call = ServiceUtil.createService(APIService.class).doLogin(body);
//        call.enqueue(new Callback<String>() {
//            @Override
//            public void onResponse(Call<String> call, Response<String> response) {
//
//                LogUtil.LogD("isSuccessful"+response.isSuccessful()+response.body());
//            }
//
//            @Override
//            public void onFailure(Call<String> call, Throwable t) {
//                LogUtil.LogD(call.toString());
//            }
//        });
    }
    private void doLogin(String account,String pwd){
        ...
        try {
            ...
            params.put("device_type","2");//1-ios,2-android
            params.put("password",Base64.encodeToString(pwd.getBytes(),Base64.DEFAULT));
            params.put("signature",Base64.encodeToString(Utils.encodeM((account+Constant.s +Utils.getDeviceId(getActivity()))).getBytes(),Base64.DEFAULT));
        } catch (JSONException e) {
            e.printStackTrace();
        }
        jsonRequest(false, params, Constant.SERVERURL, getClass().getSimpleName().toString(), new ContextRequestCallBack() {
