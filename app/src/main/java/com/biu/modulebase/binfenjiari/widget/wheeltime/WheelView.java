...
public class WheelView extends View {
    /**
     * Scrolling duration 滑动即将暂停时，控件会矫正位置，这个变量代表的是矫正的时间，时间越短，矫正越快
     */
    ...
    /**
     * Current value & label text color 居于中间的，被选中的字体颜色
     */
    private static final int VALUE_TEXT_COLOR = 0xff000000;

    /**
     * Items text color 不再中间的，没有被选中的字体颜色，或者是滚动中的颜色
     */
     ...
     */
    private static final int ADDITIONAL_ITEMS_SPACE = 16;
    ...
    //background color
    private static final int BACKGROUND_COLOR = 0xf6f6f6;
    ...
    private void initResourcesIfNecessary() {
        ...
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.biu_shape_selecttime_strip);
        }
