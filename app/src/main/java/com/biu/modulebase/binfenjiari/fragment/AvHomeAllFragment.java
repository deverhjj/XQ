...
public class AvHomeAllFragment extends BaseFragment {
     ...
     * @return
     */
    public static AvHomeAllFragment newInstance(HashMap<String, Object> args) {
        Bundle a = new Bundle();
        a.putSerializable(Constant.KEY_SEARCH_ARGS, args);
        AvHomeAllFragment avAllFragment = new AvHomeAllFragment();
        ...
        final BaseAdapter adapter=new BaseAdapter(getActivity()) {
            ...
            public BaseViewHolder getViewHolder(ViewGroup parent, int viewType) {
                BaseViewHolder holder = new BaseViewHolder(LayoutInflater.from(getActivity())
                        .inflate(viewType == TYPE_VIDEO ? R.layout.item_av_video_show_only
                                : viewType == TYPE_IT ? R.layout.item_av_image_text
                                        : R.layout.item_av_video_show_only, parent, false),
...
//                coverLayout.setVisibility(View.VISIBLE);
                ...
                holder.setNetImage(Constant.IMG_COMPRESS, R.id.iv_cover, av.getBanner_pic(), ImageDisplayUtil.DISPLAY_BIG_IMAGE);
                holder.setText(R.id.tv_title, av.getName());
                holder.setText(R.id.tv_time_total,
                        OtherUtil.getVideoTime(av.getVedio_time()));
                CheckBox like = holder.getView(R.id.like);
                like.setText(av.getLike_number());
                if (av.getLike_status()==1) {
...
//                AvVideoFragment.setupVideoItem(true, AvHomeAllFragment.this, holder, mRecyclerView,
//                        av.getUrl(), AvHomeAllFragment.this);
...
//                MediaHelper.stopPlayingVideo(holder);
    ...
    private boolean handleViewClick(View view,int position) {
        ...
        if (id == R.id.share) {
            OtherUtil.showShareFragment(AvHomeAllFragment.this, item.getId(),item.getName(),item.getName(),
            ...
            if (item != null) {
                ...
                OtherUtil.like(AvHomeAllFragment.this, (CheckBox) view, params,
    ...
    private void loadAvAllData() {
        ...
        JSONUtil.put(params,"type", mArgs.get("type")==null?"0":mArgs.get("type"));
...
//        if (!inVideoChannel || !(selectedChannel instanceof AvHomeAllFragment)) {
