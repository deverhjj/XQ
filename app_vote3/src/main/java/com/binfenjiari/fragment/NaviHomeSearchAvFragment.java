 ...
 * @date 2017/6/8
 */
public class NaviHomeSearchAvFragment extends BaseFragment {

    private RefreshRecyclerView mRefreshRecyclerView;
    private RecyclerView mRecyclerView;
    private int mPage;

    public static NaviHomeSearchAvFragment newInstance() {
        NaviHomeSearchAvFragment fragment = new NaviHomeSearchAvFragment();
        return fragment;
    }
            ...
            public BaseViewHolder getViewHolder(ViewGroup parent, int viewType) {
                ...
                if(viewType==0){
                    holder = new BaseViewHolder(LayoutInflater.from(getActivity())
                            .inflate(R.layout.item_navi_home_fixedrecyclescrollview_video, parent, false),
                            new BaseViewHolder.Callbacks2() {
                                @Override
                                public void bind(BaseViewHolder holder, Object data) {
                                    FixedRecycleScrollView_AV view = (FixedRecycleScrollView_AV) holder.itemView;
                                    view.setGridViewData();
                                }
