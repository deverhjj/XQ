 ...
 * @date 2017/6/8
 */
public class YoungReporterMediaFragment extends BaseFragment {

    private RefreshRecyclerView mRefreshRecyclerView;
    private RecyclerView mRecyclerView;
    private int mPage;

    public static YoungReporterMediaFragment newInstance() {
        YoungReporterMediaFragment fragment = new YoungReporterMediaFragment();
        return fragment;
    }
