 ...
 * @date 2017/6/8
 */
public class MinePublishDynamicFragment extends BaseFragment {

    private RefreshRecyclerView mRefreshRecyclerView;
    private RecyclerView mRecyclerView;
    private int mPage;

    public static MinePublishDynamicFragment newInstance() {
        MinePublishDynamicFragment fragment = new MinePublishDynamicFragment();
        return fragment;
    }
