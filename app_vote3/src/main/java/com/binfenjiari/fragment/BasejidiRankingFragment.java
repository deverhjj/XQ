 ...
 * @date 2017/6/8
 */
public class BasejidiRankingFragment extends BaseFragment {

    private RefreshRecyclerView mRefreshRecyclerView;
    private RecyclerView mRecyclerView;
    private int mPage;

    public static BasejidiRankingFragment newInstance() {
        BasejidiRankingFragment fragment = new BasejidiRankingFragment();
        return fragment;
    }
        ...
        BaseAdapter<String> adapter = new BaseAdapter<String>(getActivity()) {
            ...
            public BaseViewHolder getViewHolder(ViewGroup parent, int viewType) {
                ...
                holder = new BaseViewHolder(LayoutInflater.from(getActivity())
                        .inflate(R.layout.item_base_ranking_list, parent, false),
...
//                                    mBannerSliderView = (BannerSliderView) holder.itemView;
                                ...
                                Utils.setRankListState(tv_number,holder.getAdapterPosition());
                            }
