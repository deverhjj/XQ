 ...
 * @date 2017/6/8
 */
public class YoungReportRecommendFragment extends BaseFragment {

    private RefreshRecyclerView mRefreshRecyclerView;
    private RecyclerView mRecyclerView;
    private int mPage;

    public static YoungReportRecommendFragment newInstance() {
        YoungReportRecommendFragment fragment = new YoungReportRecommendFragment();
        return fragment;
    }
...
//                loadMoreData();
    ...
    private void refreshData() {
        ...
        mRefreshRecyclerView.postDelayed(new Runnable() {
            ...
            public void run() {
                inVisibleLoading();
                DataTest.loadDefiniteData(mRefreshRecyclerView, 4);
            }
        }, 1000);
    }
