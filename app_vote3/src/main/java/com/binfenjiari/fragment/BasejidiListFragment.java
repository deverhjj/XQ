 ...
 * @date 2017/6/8
 */
public class BasejidiListFragment extends BaseFragment {

    private RefreshRecyclerView mRefreshRecyclerView;
    private RecyclerView mRecyclerView;
    private int mPage;

    public static BasejidiListFragment newInstance() {
        BasejidiListFragment fragment = new BasejidiListFragment();
        return fragment;
    }
        ...
        BaseAdapter<String> adapter = new BaseAdapter<String>(getActivity()) {
            ...
            public BaseViewHolder getViewHolder(ViewGroup parent, int viewType) {
                ...
                holder = new BaseViewHolder(LayoutInflater.from(getActivity())
                        .inflate(R.layout.item_mine_collection_jidi, parent, false),
...
//                                    mBannerSliderView = (BannerSliderView) holder.itemView;
                            ...
                            public void onItemClick(BaseViewHolder holder, View view, int position) {
                                BaseJidiDetailActivity.beginActivity(getContext());
