 ...
 * @date 2017/6/8
 */
public class NaviHomeProjectListFragment extends BaseFragment {

    private RefreshRecyclerView mRefreshRecyclerView;
    private RecyclerView mRecyclerView;
    private int mPage;

    public static NaviHomeProjectListFragment newInstance() {
        NaviHomeProjectListFragment fragment = new NaviHomeProjectListFragment();
        return fragment;
    }
        ...
        BaseAdapter<String> adapter = new BaseAdapter<String>(getActivity()) {
            ...
            public BaseViewHolder getViewHolder(ViewGroup parent, int viewType) {
                ...
                holder = new BaseViewHolder(LayoutInflater.from(getActivity())
                        .inflate(R.layout.item_navi_home_project_list, parent, false),
...
//                                    mBannerSliderView = (BannerSliderView) holder.itemView;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.menu_navi_project, menu);
