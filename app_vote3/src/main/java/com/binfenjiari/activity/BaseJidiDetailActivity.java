...
public class BaseJidiDetailActivity extends BaseActivity {
    ...
    private static final String[] TABNAMES = {"基地详情", "评价(5)"};
    ...
    public static void beginActivity(Context context) {
        Intent intent = new Intent(context, BaseJidiDetailActivity.class);
//        intent.putExtra("type", TYPE_LOGIN);
    ...
    protected void setActView() {
        setContentView(R.layout.activity_basejidi_detail_tablayout);
    ...
    public void loadData(){
        HeadViewBasejidiDetail headView = new HeadViewBasejidiDetail(this);
