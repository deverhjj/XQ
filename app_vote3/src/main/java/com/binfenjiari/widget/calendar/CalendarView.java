...
public class CalendarView extends WrapContentViewPager implements OnDateChangedListener, CalendarCallback {
    ...
    private ArrayList money = new ArrayList();
    ...
    public void setNumbers(ArrayList numbers) {
        ...
        monthView.refreshNumber(numbers);
        this.numbers=numbers;
    }
    public void setMoney(ArrayList numbers) {
        MonthView monthView=adapter.getViews().get(getCurrentItem());
        monthView.refreshMoney(numbers);
        money=numbers;
    }
    ...
    public class CalendarAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            MonthView v = new MonthView(CalendarView.this.getContext(), CalendarDay.from(c), CalendarView.this.startsOnSunday, this.mCallback, this.mListener, getCurrentItem(), numbers);
