...
//    private MyHandler mHandler;
    ...
    public SliderViewNavigation(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SliderViewNavigation(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = inflate(context, R.layout.widget_navigation_silder_view, this);
        navigationsliderview_container = (RelativeLayout) view.findViewById(R.id.navigationsliderview_container);
        bannerViewPager = (ViewPager) view.findViewById(R.id.navigationsliderview_viewpager);
...
//        }
    ...
    public void loadBannerData(List<String> banners) {
        ...
        if (navigationsliderview_ll_dot_group_banner.getChildCount() == size) {
            return;
        }
        for (int i = 0; i < size; i++) {
            ...
            dot.setBackgroundResource(R.drawable.selector_navigation_line);
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(dp2px(getContext(), 18), dp2px(getContext(), 2));
            params.leftMargin = 10;
            dot.setEnabled(false);
            dot.setLayoutParams(params);
            navigationsliderview_ll_dot_group_banner.addView(dot); // 向线性布局中添加"点"
        }
        BannerAdapter bannerAdapter = new BannerAdapter(navigationsliderview_ll_dot_group_banner, banners);
        bannerViewPager.setAdapter(bannerAdapter);
        bannerViewPager.addOnPageChangeListener(bannerAdapter);

        navigationsliderview_ll_dot_group_banner.getChildAt(0).setSelected(true);
...
//        startBanner();
    ...
    private class BannerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            View view = View.inflate(getContext(), R.layout.widget_navigation_item_slideview_one, null);
...
//            ImageDisplayUtil.LoadNetImage(imageView, getContext(), banneritem.getImg());
            ...
            view.findViewById(R.id.fl_slide_report).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    YoungReporterActivity.beginActivity(getContext());
                }
            });

            view.findViewById(R.id.fl_slide_movement).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    NaviHomeMovementListActivity.beginActivity(getContext());
                }
            });

            view.findViewById(R.id.fl_slide_base_activity).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    NaviHomeBaseListActivity.beginActivity(getContext());
                }
            });

            view.findViewById(R.id.fl_slide_project).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    NaviHomeProjectListActivity.beginActivity(getContext());
                }
            });

            view.findViewById(R.id.fl_slide_video).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    NaviHomeVideoAudioActivity.beginActivity(getContext());
                }
            });
